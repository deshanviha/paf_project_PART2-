			...
			<div class="col-6">
				...
				<form id="formFund" name="formFund" method="post" action="fund.jsp">
					Funder Name: <input id="funderName" name="funderName" type="text"
						...
						id="fundDate" name="fundDate" type="date"
						class="form-control form-control-sm"> <br> Fund
					Price: <input id="fundPrice" name="fundPrice" type="text"
						class="form-control form-control-sm"> <br> Fund
					category: <input id="fundCate" name="fundCate" type="text"
						class="form-control form-control-sm"> <br>
					Description:
					<textarea class="form-control" id="fundDesc" name="fundDesc"
						rows="3"></textarea>
